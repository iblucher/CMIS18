...
%
% fd=inline('drectangle(p,-3,3,-1,1)','p');
...
for e=1:cntT
  ...
  error('Compute element stiffness matrix and store it in Ke array')  
  %Ke( 1:6, (6*(e-1)+1) :(6*e)) =  ....????
...
for e=1:cntT
  ...
  error('assemble Ke into global K matrix')
...
for i = 1: length(indices)
  ...
  error('Add boundary conditions here')
end
